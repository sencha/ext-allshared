...
//        console.log(window.it.callIt)

//        window.it.callIt(Ext.getCmp(currElement.id).xtype)



var xtype = Ext.getCmp(currElement.id).xtype;

//console.log(window.top)
//        window.top.postMessage(Ext.getCmp(currElement.id).xtype, '*')
        fl.innerHTML =
            xtype
            + "<br/><br/>"
            + s;

        var data = { xtype: xtype }
