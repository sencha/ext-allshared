                            ...
                            if (method in this && !init.has(this)) {
                                ...
                                if (ownerDocument.readyState === 'complete' || isParsed(self))
                                {
                                    ...
                                    if (window.Ext == undefined) {
                                        ...
                                        striptTag.src = './node_modules/@sencha/ext-web-components/ext-runtime/engine.js';
                                        striptTag.onload = function() {
                                            var linkTag = document.createElement('link');
                                            linkTag.rel = 'stylesheet';
                                            linkTag.type = 'text/css';
                                            linkTag.href = './node_modules/@sencha/ext-web-components/ext-runtime/theme/material/material-all.css';
