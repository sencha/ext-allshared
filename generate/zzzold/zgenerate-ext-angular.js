...
const templateToolkitFolder = "./filetemplates/" + framework + "/";
...
function writeFile(framework, tplFile, outFile, vars) {
    ...
    var tFile = path.resolve(templateToolkitFolder + tplFile).toString()
...
function writeFile2(framework, tplFile, outFile, vars) {
    //var templateToolkitFolder = path.resolve(templateToolkitFolder);
    //console.log(templateToolkitFolder)
    //console.log(tplFile)
    //console.log(path.resolve(templateToolkitFolder, tplFile))
    //console.log('***')
    //console.log(path.resolve(templateToolkitFolder + tplFile)).toString()
    var tpl = new Ext.XTemplate(fs.readFileSync(path.resolve(templateToolkitFolder + tplFile)))
    //console.log(tpl)
    var t = tpl.apply(vars)
    //console.log(t)
    //console.log(outFile)
...
function doPostLaunch() {
    ...
    writeFile2(framework, '/doc.tpl', `${docFolder}doc.html`, info)
    writeFile2(framework, '/docstyle.tpl', `${docFolder}docstyle.css`, info)
    ...
    if (framework == 'web-components') {
        ...
        copyFileSync(templateToolkitFolder+`/src/HTMLParsedElement.js`, toolkitFolder+`/src/HTMLParsedElement.js`);
        copyFileSync(templateToolkitFolder+`/.babelrc`, toolkitFolder+`.babelrc`);
        ...
        copyFileSync(templateToolkitFolder+`tsconfig.json`, toolkitFolder+`tsconfig.json`);
        copyFileSync(templateToolkitFolder+`tsconfig.lib.json`, toolkitFolder+`tsconfig.lib.json`);
        copyFileSync(templateToolkitFolder+`ng-package.json`, toolkitFolder+`ng-package.json`);
    ...
    writeTemplateFile(templateToolkitFolder+`${shortname}-base.tpl`,`${srcFolder}${shortname}-base.${extension}`,info);
